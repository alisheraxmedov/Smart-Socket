...
class YotoqxonaScreen extends StatelessWidget {
  static const String routeName = "/yotoqxona";
  const YotoqxonaScreen({super.key});
...
//================== Xonaning qurilmalari ==================
              SliverGrid.builder(
                itemCount: RoomItems.yotoqxonaDeviceName.length,
...
//================== Xonaning qurilmasining nomi ==================
                          TextWidget(
                            data: RoomItems.yotoqxonaDeviceNameUzb[index],
                            size: width * .05,
                            weight: FontWeight.bold,
                          ),
//================== Xonaning qurilmasining iconButtoni ==================
                          GestureDetector(
                            onTap: () {
                              reference.child("Bed Room").update({
                                RoomItems.yotoqxonaDeviceName[index]:
                                    Provider.of<ProviderClass>(context,
                                                        listen: false)
                                                    .realtimeData["Bed Room"]
                                                [RoomItems.yotoqxonaDeviceName[
                                                    index]] ==
                                            0
                                        ? 1
                                        : 0
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: Provider.of<ProviderClass>(context,
                                                ...
                                                .realtimeData["Bed Room"][
                                            RoomItems
                                                .yotoqxonaDeviceName[index]] ==
                                        0
                                    ? ColorsClass.white
                                    : ColorsClass.buttonBlue,
                                image: DecorationImage(
                                  image: AssetImage(
                                    RoomItems.yotoqxonaDevice[index],
                                  ),
                                  fit: BoxFit.cover,
                                ),
                              ),
