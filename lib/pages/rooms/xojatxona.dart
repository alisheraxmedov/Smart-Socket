...
class XojatxonaScreen extends StatelessWidget {
  static const String routeName = "/xojatxona";
  const XojatxonaScreen({super.key});
...
//================== Xonaning qurilmalari ==================
              SliverGrid.builder(
                itemCount: RoomItems.xojatxonaDeviceName.length,
...
//================== Xonaning qurilmasining nomi ==================
                          TextWidget(
                            data: RoomItems.xojatxonaDeviceNameUzb[index],
                            size: width * .05,
                            weight: FontWeight.bold,
                          ),
//================== Xonaning qurilmasining iconButtoni ==================
                          GestureDetector(
                            onTap: () {
                              reference.child("Toilet").update({
                                RoomItems.xojatxonaDeviceName[index]:
                                    Provider.of<ProviderClass>(context,
                                                        listen: false)
                                                    .realtimeData["Toilet"]
                                                [RoomItems.xojatxonaDeviceName[
                                                    index]] ==
                                            0
                                        ? 1
                                        : 0
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: Provider.of<ProviderClass>(context,
                                                ...
                                                .realtimeData["Toilet"][
                                            RoomItems
                                                .xojatxonaDeviceName[index]] ==
                                        0
                                    ? ColorsClass.white
                                    : ColorsClass.buttonBlue,
                                image: DecorationImage(
                                  image: AssetImage(
                                    RoomItems.xojatxonaDevice[index],
                                  ),
                                  fit: BoxFit.cover,
                                ),
                              ),
