...
class OshxonaScreen extends StatelessWidget {
  static const String routeName = "/oshxona";
  const OshxonaScreen({super.key});
...
//================== Xonaning qurilmalari ==================
              SliverGrid.builder(
                itemCount: RoomItems.oshxonaDeviceName.length,
...
//================== Xonaning qurilmasining nomi ==================
                          TextWidget(
                            data: RoomItems.oshxonaDeviceNameUzb[index],
                            size: width * .05,
                            weight: FontWeight.bold,
                          ),
//================== Xonaning qurilmasining iconButtoni ==================
                          GestureDetector(
                            onTap: () {
                              reference.child("Kitchen").update({
                                RoomItems.oshxonaDeviceName[index]:
                                    Provider.of<ProviderClass>(context,
                                                        listen: false)
                                                    .realtimeData["Kitchen"]
                                                [RoomItems.oshxonaDeviceName[
                                                    index]] ==
                                            0
                                        ? 1
                                        : 0
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: Provider.of<ProviderClass>(context,
                                                ...
                                                .realtimeData["Kitchen"][
                                            RoomItems
                                                .oshxonaDeviceName[index]] ==
                                        0
                                    ? ColorsClass.white
                                    : ColorsClass.buttonBlue,
                                image: DecorationImage(
                                  image: AssetImage(
                                    RoomItems.oshxonaDevice[index],
                                  ),
                                  fit: BoxFit.cover,
                                ),
                              ),
