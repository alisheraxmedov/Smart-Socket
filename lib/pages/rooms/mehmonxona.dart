...
class MehmonxonaScreen extends StatelessWidget {
  static const String routeName = "/mehmonxona";
...
//================== Xonaning qurilmalari ==================
              SliverGrid.builder(
                itemCount: RoomItems.mehmonxonaDeviceName.length,
...
//================== Xonaning qurilmasining nomi ==================
                          TextWidget(
                            data: RoomItems.mehmonxonaDeviceNameUzb[index],
                            size: width * .05,
                            weight: FontWeight.bold,
                          ),
//================== Xonaning qurilmasining iconButtoni ==================
                          GestureDetector(
                            onTap: () {
                              reference.child("Living Room").update({
                                RoomItems.mehmonxonaDeviceName[index]:
                                    Provider.of<ProviderClass>(context,
                                                        listen: false)
                                                    .realtimeData["Living Room"]
                                                [RoomItems.mehmonxonaDeviceName[
                                                    index]] ==
                                            0
                                        ? 1
                                        : 0
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: Provider.of<ProviderClass>(context,
                                                ...
                                                .realtimeData["Living Room"][
                                            RoomItems
                                                .mehmonxonaDeviceName[index]] ==
                                        0
                                    ? ColorsClass.white
                                    : ColorsClass.buttonBlue,
                                image: DecorationImage(
                                  image: AssetImage(
                                    RoomItems.mehmonxonaDevice[index],
                                  ),
                                  fit: BoxFit.cover,
                                ),
                              ),
